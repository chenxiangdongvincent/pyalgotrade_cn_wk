...
class DefaultStrategy(FillStrategy):
    ...
    * A :class:`pyalgotrade.broker.StopLimitOrder` will be filled like this:
    ...
    def onBars(self, broker_, bars):
        ...
        self.__volumeBegin = volumeBegin
    ...
    def __calculateFillSize(self, broker_, order, bar):
        ...
        #NEWLY ADD
        #print 'test in calculateFillSize'
        print order.getInstrument()
        #print order.getRemaining()
        """
        print "current positions of instruments is"
        print broker_.getPositions().get(order.getInstrument())
        print '\n'
        """
        ...
        if order.isSell():
            ...
            ret = min(ret, self.__volumeBegin.get(order.getInstrument()))
            print "can not sell more than original,number is"
            print ret
