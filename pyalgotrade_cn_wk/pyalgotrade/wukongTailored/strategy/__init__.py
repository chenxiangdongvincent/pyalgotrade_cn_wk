...
import pyalgotrade.wukongTailored.broker
from pyalgotrade.wukongTailored.broker import backtesting
from pyalgotrade import observer
from pyalgotrade import dispatcher
import pyalgotrade.wukongTailored.strategy.position
...
class BaseStrategy(object):
    ...
    def enterLong(self, instrument, quantity, goodTillCanceled=False, allOrNone=False):
        ...
        #修改包含路径
        return pyalgotrade.wukongTailored.strategy.position.LongPosition(self, instrument, None, None, quantity, goodTillCanceled, allOrNone)
    ...
    def enterShort(self, instrument, quantity, goodTillCanceled=False, allOrNone=False):
        ...
        return pyalgotrade.wukongTailored.strategy.position.ShortPosition(self, instrument, None, None, quantity, goodTillCanceled, allOrNone)
    ...
    def enterLongLimit(self, instrument, limitPrice, quantity, goodTillCanceled=False, allOrNone=False):
        ...
        return pyalgotrade.wukongTailored.strategy.position.LongPosition(self, instrument, None, limitPrice, quantity, goodTillCanceled, allOrNone)
    ...
    def enterShortLimit(self, instrument, limitPrice, quantity, goodTillCanceled=False, allOrNone=False):
        ...
        return pyalgotrade.wukongTailored.strategy.position.ShortPosition(self, instrument, None, limitPrice, quantity, goodTillCanceled, allOrNone)
    ...
    def enterLongStop(self, instrument, stopPrice, quantity, goodTillCanceled=False, allOrNone=False):
        ...
        return pyalgotrade.wukongTailored.strategy.position.LongPosition(self, instrument, stopPrice, None, quantity, goodTillCanceled, allOrNone)
    ...
    def enterShortStop(self, instrument, stopPrice, quantity, goodTillCanceled=False, allOrNone=False):
        ...
        return pyalgotrade.wukongTailored.strategy.position.ShortPosition(self, instrument, stopPrice, None, quantity, goodTillCanceled, allOrNone)
    ...
    def enterLongStopLimit(self, instrument, stopPrice, limitPrice, quantity, goodTillCanceled=False, allOrNone=False):
        ...
        return pyalgotrade.wukongTailored.strategy.position.LongPosition(self, instrument, stopPrice, limitPrice, quantity, goodTillCanceled, allOrNone)
    ...
    def enterShortStopLimit(self, instrument, stopPrice, limitPrice, quantity, goodTillCanceled=False, allOrNone=False):
        ...
        return pyalgotrade.wukongTailored.strategy.position.ShortPosition(self, instrument, stopPrice, limitPrice, quantity, goodTillCanceled, allOrNone)
