...
class BasicBar(Bar):
    ...
    #新增三个输入参数
    def __init__(self, dateTime, open_, high, low, close, volume, adjClose,new_column,tradeStatus,maxUpDownStatus, frequency, extra={}):
        if high < low:
        ...
        self.__tradeStatus = tradeStatus
        self.__maxUpDownStatus = maxUpDownStatus
