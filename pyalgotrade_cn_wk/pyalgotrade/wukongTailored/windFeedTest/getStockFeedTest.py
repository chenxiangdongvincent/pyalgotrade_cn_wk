    ...
    def AStockHisData(self,symbols,start_date,end_date,step=0):
        ...
        for symbol in symbols:     #遍历股票池
            ...
            try:
                ...
                """
                for item in index_data['trade_status']:
                    ...
                    if item ==u'交易':
                        ...
                        index_data['new_column']=0
                                  
                index_data['trade_status'] = index_data['new_column']
                """
                        
                #print  index_data['trade_status']
                
                index_data.to_csv("dataFileFeed/"+str(symbol)+ ".csv",index = False,encoding="gbk")  #去除索引
